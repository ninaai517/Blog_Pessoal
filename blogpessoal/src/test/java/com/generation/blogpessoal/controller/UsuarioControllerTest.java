...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) /*-> Ajuda ordenar a sequencia da execução dos testes*/
	...
	@Autowired
		...
		public void deveCriarUmUsuario() {
			...
			ResponseEntity<Usuario> resposta = testRestTemplate
				...
				//Exchange -> equivale ao botão Send no Insomnia: end.point + verbo + request + response;
